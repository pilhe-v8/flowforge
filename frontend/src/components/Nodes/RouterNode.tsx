...
import { RouterNodeData } from '../../types';
...
export function RouterNode({ data, selected, id }: NodeProps) {
  ...
  return (
    <div className={[
      'relative rounded-lg border-2 p-3 min-w-[180px] bg-yellow-50 border-yellow-300',
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="font-medium text-sm">{d.label || 'Router'}</span>
      </div>
      <div className="text-xs text-gray-500 mt-1 truncate">{d.routeOn || 'No variable selected'}</div>
