...
export function AgentNode({ data, selected, id }: NodeProps) {
  ...
  return (
    <div className={[
      'relative rounded-lg border-2 p-3 min-w-[180px] bg-orange-50 border-orange-300',
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="font-medium text-sm">{d.label || 'Agent'}</span>
      </div>
      <div className="text-xs text-gray-500 mt-1">{d.agentSlug || 'No agent selected'}</div>
